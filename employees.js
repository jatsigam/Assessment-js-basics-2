...
class Employee{
    ...
    getSchedule(){
        return(`${this.name} works in the ${this.shifts} shift`)
    }
}
...
//CODE HERE
const empOne = new Employee('Jatou','morning')
...
const empTwo = {...empOne} //Create empTwo variable using spread operator
empTwo.name = 'Nick' // change name of 'empTwo' to Nick
console.log(empTwo)
...
//CODE HERE
let manager = new Manager('Jonathan','evening',['Mary', 'Ann', 'James'])
