...
let result = deals[0].title.replace('15','10') //Use replace method to replace 15 with 10
console.log(result)

// Personal Notes - Another way of replacing
...
//CODE HERE
let result2 = deals[1].desc.replace('March','April') // replace March w/ April
let trimmedString = result2.trim() // Trim result to remove spaces
console.log(trimmedString) //Print